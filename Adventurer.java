public abstract class Adventurer implements Entity {
  ...
  public void heal(int amount) {
    ...
    //If health is less than base health of the adventurer
    if (health < baseHealth) {
      health += amount; //Add the amount of health signified by the parameter

      //If health is greater than base health then set the health to equal the base health of the adventurer.
      if (health > baseHealth) {
        health = baseHealth;
      }
    }
