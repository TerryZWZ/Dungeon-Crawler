  ...
  public String attack(Entity enemy, boolean defending) {
    ...
    if (enemy != null) {
      if (this.mana > 0) {
        ...
        // If player chooses a particular number,they use listed ability
        ...
        // If player chooses anything else, they attack weakly
        else {
          System.out.println(YELLOW + this.name + " stumbles and gently taps on the monster" + GREEN);
